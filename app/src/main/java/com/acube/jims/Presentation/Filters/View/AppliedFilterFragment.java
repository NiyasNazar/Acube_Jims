...
public class AppliedFilterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String pricerange = FilterPreference.retrieveStringPreferences(getActivity(), "pricenames");
        String gender = FilterPreference.retrieveStringPreferences(getActivity(), "gender");
        ...
        binding.tvname.setText(FilterPreference.retrieveStringPreferences(getActivity(), "catname"));
    ...
    public List<String> getList(String filtername) {
        ...
        String serializedObject = FilterPreference.retrieveStringPreferences(getActivity(), filtername);
