...
public class ColorFilterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.setAdapter(new FilterColorAdapter(getActivity(), getList()));
        return view;
    }
    public List<Colorresult> getList() {
        List<Colorresult> mMainCategory = null;
        String serializedObject = LocalPreferences.retrieveStringPreferences(getActivity(), "colorresults");
