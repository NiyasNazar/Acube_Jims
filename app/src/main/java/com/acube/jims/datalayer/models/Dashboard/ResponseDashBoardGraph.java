...
public class ResponseDashBoardGraph {
    ...
    @Expose
    private List<DashboardDataSingleBar> dashboardDataSingleBar = null;
    ...
    public List<DashboardDataSingleBar> getDashboardDataSingleBar() {
        return dashboardDataSingleBar;
    }

    public void setDashboardDataSingleBar(List<DashboardDataSingleBar> dashboardDataSingleBar) {
