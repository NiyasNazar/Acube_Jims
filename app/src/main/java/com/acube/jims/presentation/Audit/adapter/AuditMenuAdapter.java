...
public class AuditMenuAdapter extends RecyclerView.Adapter<AuditMenuAdapter.ProductViewHolder> {
    ...
    public AuditMenuAdapter(Context mCtx, List<HomeData> homemenuList, FragmentTransition fragmenttransition) {
        this.mCtx = mCtx;
        ...
        public ProductViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    fragmenttransition.replaceFragment(homemenuList.get(getAbsoluteAdapterPosition()).getMenuText());
