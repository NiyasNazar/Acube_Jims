...
int GuestCustomerID;
    ...
    //    viewModel.FetchCatalog(AppConstants.Authorization + AuthToken, PAGE_START, AppConstants.Pagesize, vaCatID, vaSubCatID, vaColorID, vaKaratID, vaWeight, vaPriceMin, vapriceMax, vagender,0,GuestCustomerID);
    ...
    private void loadNextPage() {
       ...
       // catalogViewModelNextPage.FetchCatalog(AppConstants.Authorization + AuthToken, currentPage, AppConstants.Pagesize, vaCatID, vaSubCatID, vaColorID, vaKaratID, vaWeight, vaPriceMin, vapriceMax, vagender,0,GuestCustomerID);
    ...
    public void replace(String Id) {
      ...
      //  FragmentHelper.replaceFragment(requireActivity(), R.id.content, ProductDetailsFragment.newInstance(Id));
    ...
    public <T> void setList(String key, List<T> list) {
        ...
        LocalPreferences.storeStringPreference(requireActivity(), key, json);
    }
