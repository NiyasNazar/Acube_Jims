...
public class CatalogViewModel extends AndroidViewModel {
    ...
    public void FetchCatalog(String Auth, int PageNum, int PageSize, String CatID, String SubCatID, String ColorCode, String KaratCode, String MinWeight, String MaxWeight, String priceMin, String priceMax, String gender, int ID, int customerID, int warehouseId , Context context) {
        repository.FetchCatalogueItems(Auth, PageNum, PageSize, CatID, SubCatID, ColorCode, KaratCode,  MinWeight, MaxWeight, priceMin, priceMax, gender,ID,customerID,warehouseId,context);
    }

    public void FetchCatalogSummary(String Auth, int PageNum, int PageSize, String CatID, String SubCatID, String ColorCode, String KaratCode, String MinWeight,String MaxWeight, String priceMin, String priceMax, String gender,int customerID,Context context) {
