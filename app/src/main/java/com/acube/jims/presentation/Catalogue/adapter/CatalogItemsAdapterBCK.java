...
public class CatalogItemsAdapterBCK extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CatalogItemsAdapterBCK(Context context, replaceFregment replaceFregment, AddtoFavorites addtoFavorites) {
