...
public class CatalogSummaryItemsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CatalogSummaryItemsAdapter(Context context, replaceFregment replaceFregment, AddtoFavorites addtoFavorites) {
    ...
    private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
        ...
        View view1 = inflater.inflate(R.layout.layout_catalog_item_summary, parent, false);
        ...
        public CatalogVH(View itemView) {
            ...
            mlikebtn.setOnLikeListener(new OnLikeListener() {
                ...
                public void liked(LikeButton likeButton) {
                    addtoFavorites.addtofav(String.valueOf(dataset.get(getBindingAdapterPosition()).getId()), dataset.get(getBindingAdapterPosition()).getSerialNumber());
