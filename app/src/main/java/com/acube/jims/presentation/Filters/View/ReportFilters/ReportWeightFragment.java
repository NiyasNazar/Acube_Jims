 ...
 * Use the {@link ReportWeightFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ReportWeightFragment extends Fragment implements RefreshSelection {
    ...
    public static ReportWeightFragment newInstance(String param1, String param2) {
        ReportWeightFragment fragment = new ReportWeightFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.setAdapter(new FilterWeightAdapter(getActivity(), getList(), ReportWeightFragment.this));
        return view;
    }
    ...
    @Override
    public void refresh() {
        ReportFilterBottomSheetFragment parentFrag = ((ReportFilterBottomSheetFragment) ReportWeightFragment.this.getParentFragment());
        parentFrag.Refresh();
    }
}