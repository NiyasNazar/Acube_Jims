...
import com.acube.jims.rfid.Comm;
...
public class SmartTrayReading extends AppCompatActivity implements OnOpenSerialPortListener, View.OnClickListener, PacketParser.OnPacketParseListener {
...
//            btn_setup.setText("关闭");
    ...
    public void onPacketReceived(byte[] packet) {
        ...
        Log.d("TAG", "onPacketReceived: " + paramHashMap.get("EPC"));
