...
public class SearchableSpinners extends Spinner implements View.OnTouchListener,
    ...
    public SearchableSpinners(Context context) {
        super(context);
        this._context = context;
        init();
    }

    public SearchableSpinners(Context context, AttributeSet attrs) {
        super(context, attrs);
        this._context = context;
    ...
    public SearchableSpinners(Context context, AttributeSet attrs, int defStyleAttr) {
